...
const StudentTimeTable = () => {
  return (
    <>
      <ScheduleTable apiEndpoint={`${import.meta.env.VITE_BASE_URL}/api/engxi`} title="Computer (XI) Time Table" />
      <ScheduleTable apiEndpoint={`${import.meta.env.VITE_BASE_URL}/api/commercexi`} title="Commerce (XI) Time Table" />
      <ScheduleTable apiEndpoint={`${import.meta.env.VITE_BASE_URL}/api/genscixi`} title="Science (XI) Time Table" />
      <ScheduleTable apiEndpoint={`${import.meta.env.VITE_BASE_URL}/api/commercexii`} title="Commerce (XII) Time Table" />
      <ScheduleTable apiEndpoint={`${import.meta.env.VITE_BASE_URL}/api/genscixii`} title="Science (XII) Time Table" />
