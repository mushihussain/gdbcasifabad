  ...
  return (
    <div className="navbar  fixed top-0 left-0 md:left-[230px] w-full md:w-[calc(100%-220px)] bg-gray-700 dark:bg-gray-800 flex justify-between items-center px-4 py-2 shadow-md z-50 md:px-6 md:py-4">
      <div className="flex items-center space-x-4">
        <img className="logo w-8 md:w-10" src='https://res.cloudinary.com/dzr3drmyk/image/upload/v1741383816/user_eqzvbl.avif' alt="Logo" />
      </div>
      ...
      <img className="profile w-8 h-8 md:w-10 md:h-10 rounded-full" src='https://res.cloudinary.com/dzr3drmyk/image/upload/v1741383816/user_eqzvbl.avif' alt="Profile" />
    </div>
  );
};
